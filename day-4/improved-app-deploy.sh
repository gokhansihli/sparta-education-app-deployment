...
# updates/downloads packages
sudo apt update -y

# upgrade/installs packages
sudo apt upgrade -y
...
# To deploy app, 
# sudo nano adv-app-deploy.sh
# bash adv-app-deploy.sh or source adv-app-deploy.sh
# You should see "Your app is ready and listening on port 3000"

# This script is advance version of day-3 sparta-app-deploy.md script